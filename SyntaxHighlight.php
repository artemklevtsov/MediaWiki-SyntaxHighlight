...
$wgResourceModules['ext.SyntaxHighlight'] = array(
    ...
    'styles' => array('highlight.js/styles/'.$wgSyntaxHighlightStyle.'.css', 'ext.SyntaxHighlight.css'),
    'scripts' => array('highlight.js/highlight.pack.js', 'ext.SyntaxHighlight.js')
);
